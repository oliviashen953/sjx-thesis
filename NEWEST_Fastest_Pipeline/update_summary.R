...
output_directory <- "/n/holyscratch01/duan_lab/jiaxin/NEW_NORMAL"
iterations <- 30
train_size <- 3000
n_groups <- 20
group_size <- 3000
...
adjusted_output_folder <- "/n/holyscratch01/duan_lab/jiaxin/NEW_NORMAL/SVD_adjusted_score_results"
...
folders <- list(
  "height" = "/n/holyscratch01/duan_lab/jiaxin/NEW_NORMAL/2.2_height_transposed_files",
  "bmi" = "/n/holyscratch01/duan_lab/jiaxin/NEW_NORMAL/2.2_bmi_transposed_files",
  "brc" = "/n/holyscratch01/duan_lab/jiaxin/NEW_NORMAL/2.2_brc_transposed_files"
)
...
adjusted_score_dir <- "/n/holyscratch01/duan_lab/jiaxin/NEW_NORMAL/SVD_adjusted_score_results"
ranked_score_dir <- "/n/holyscratch01/duan_lab/jiaxin/NEW_NORMAL/SVD_adjusted_ranked_score_results"
...
bmi_svd_ranked_dir <- "/n/holyscratch01/duan_lab/jiaxin/NEW_NORMAL/2.2_bmi_SVD_ranked_transposed_files"
brc_svd_ranked_dir <- "/n/holyscratch01/duan_lab/jiaxin/NEW_NORMAL/2.2_brc_SVD_ranked_transposed_files"
height_svd_ranked_dir <- "/n/holyscratch01/duan_lab/jiaxin/NEW_NORMAL/2.2_height_SVD_ranked_transposed_files"
...
adjusted_score_dir <- "/n/holyscratch01/duan_lab/jiaxin/NEW_NORMAL/SVD_adjusted_ranked_score_results"
