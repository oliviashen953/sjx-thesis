...
#SBATCH -J NNM_call               # Job name
#SBATCH -o NNM_call.out           # Standard output file
#SBATCH -e NNM_call.err           # Standard error file
...
matlab -nodisplay -r "run('/n/home00/jiaxinshen//NNM_call.m'); exit;"
