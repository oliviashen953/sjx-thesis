...
#############################################
#############################################
#### CHANGE THE OUTPUT DIRECROTY!!! ####
#############################################
#############################################
#############################################
#############################################
output_directory <- "/n/holyscratch01/duan_lab/jiaxin/NEW_RACE_AFR"
...
perform_sampling_AFR <- function(data, prefix, n_train, n_groups, n_group_size, iterations, directory) {
  # Create the main directory if it doesn't exist
  if (!dir.exists(directory)) {
    dir.create(directory, recursive = TRUE)
  }
...
perform_sampling_AFR(height_data, "height", train_size, n_groups, group_size, iterations, output_directory)
perform_sampling_AFR(bmi_data, "bmi", train_size, n_groups, group_size, iterations, output_directory)
perform_sampling_AFR(brc_data, "brc", train_size, n_groups, group_size, iterations, output_directory)
...
adjusted_output_folder <- "/n/holyscratch01/duan_lab/jiaxin/NEW_RACE_AFR/SVD_adjusted_score_results"
...
folders <- list(
  "height" = "/n/holyscratch01/duan_lab/jiaxin/NEW_RACE_AFR/2.2_height_transposed_files",
  "bmi" = "/n/holyscratch01/duan_lab/jiaxin/NEW_RACE_AFR/2.2_bmi_transposed_files",
  "brc" = "/n/holyscratch01/duan_lab/jiaxin/NEW_RACE_AFR/2.2_brc_transposed_files"
)
...
adjusted_score_dir <- "/n/holyscratch01/duan_lab/jiaxin/NEW_RACE_AFR/SVD_adjusted_score_results"
ranked_score_dir <- "/n/holyscratch01/duan_lab/jiaxin/NEW_RACE_AFR/SVD_adjusted_ranked_score_results"
...
bmi_svd_ranked_dir <- "/n/holyscratch01/duan_lab/jiaxin/NEW_RACE_AFR/2.2_bmi_SVD_ranked_transposed_files"
brc_svd_ranked_dir <- "/n/holyscratch01/duan_lab/jiaxin/NEW_RACE_AFR/2.2_brc_SVD_ranked_transposed_files"
height_svd_ranked_dir <- "/n/holyscratch01/duan_lab/jiaxin/NEW_RACE_AFR/2.2_height_SVD_ranked_transposed_files"
...
adjusted_score_dir <- "/n/holyscratch01/duan_lab/jiaxin/NEW_RACE_AFR/SVD_adjusted_ranked_score_results"
