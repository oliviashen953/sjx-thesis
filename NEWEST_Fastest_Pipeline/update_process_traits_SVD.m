function update_process_traits_SVD(trait_name, base_directory, data_range, prefix, matlab_script_path)
    ...
    for subgroup = 1:20
        for iteration = 1:30
            ...
            file_name = sprintf('ranked_transposed_%s_subgroup_%d_iteration_%d.csv', trait_name, subgroup, iteration);
