...
#SBATCH -J NNM_call_AFR               # Job name
#SBATCH -o NNM_call_AFR.out           # Standard output file
#SBATCH -e NNM_call_AFR.err           # Standard error file
...
matlab -nodisplay -r "run('/n/home00/jiaxinshen//NNM_call_AFR.m'); exit;"