...
##################################################################  
##################################################################
##### HEIGHT: Unsupervised RA Methods Calcluation ################
##################################################################
##################################################################


################################################################################################
#### STEP (1) SUBGROUP DATASETS GATHERED TO A SINGLE FILE: "2.2_height_test_subgroup_files" ####
################################################################################################

# Define the directories
old_dir <- "~/"
new_dir <- "2.2_height_test_subgroup_files"

# Create the new directory if it does not exist
dir.create(new_dir, showWarnings = FALSE)

# List all files matching the pattern in the current directory
height_files <- list.files(path = old_dir, pattern = "^height_subgroup_\\d+_iteration_\\d+\\.csv$", full.names = TRUE)
...
# input_dir <- "2.2_height_test_subgroup_files"
# output_dir <- "2.2_height_transposed_files_test"
# 
# # Create the new directory if it does not exist
# dir.create(output_dir, showWarnings = FALSE)
# 
# # Define the single file to be tested
# test_file <- file.path(input_dir, "height_subgroup_1_iteration_1.csv")
# 
...
# library(readr)
# height_subgroup_1_iteration_1 <- read_csv("2.2_height_test_subgroup_files/height_subgroup_1_iteration_1.csv")
# View(height_subgroup_1_iteration_1)
# 
# 
# library(readr)
# transposed_height_subgroup_1_iteration_1 <- read_csv("2.2_height_transposed_files_test/transposed_height_subgroup_1_iteration_1.csv")
# View(transposed_height_subgroup_1_iteration_1)
# 
...
# Define the directories
input_dir <- "2.2_height_test_subgroup_files"
transposed_dir <- "2.2_height_transposed_files"
ranked_dir <- "2.2_height_ranked_transposed_files"
...
height_files <- list.files(path = input_dir, pattern = "^height_subgroup_\\d+_iteration_\\d+\\.csv$", full.names = TRUE)
...
# input_dir <- "2.2_height_test_subgroup_files"
# output_dir <- "2.2_height_transposed_files"
# 
# # Create the new directory if it does not exist
# dir.create(output_dir, showWarnings = FALSE)
# 
...
# 
# 
# # Define the directories for height, bmi, and brc
# directories <- list(
#   height = "2.2_height_test_subgroup_files",
#   bmi = "2.2_bmi_test_subgroup_files",
#   brc = "2.2_brc_test_subgroup_files"
# )
# 
# # Create the new directories if they do not exist
...
# 
# # Move height files
# height_files <- list.files(path = "~/", pattern = "^height_subgroup_\\d+_iteration_\\d+\\.csv$", full.names = TRUE)
# for (file in height_files) {
#   new_file <- file.path(directories$height, basename(file))
#   file.rename(file, new_file)
# }
# print("Height files have been moved to the new directory.")
# 
# # Move bmi files
# bmi_files <- list.files(path = "~/", pattern = "^bmi_subgroup_\\d+_iteration_\\d+\\.csv$", full.names = TRUE)
# for (file in bmi_files) {
#   new_file <- file.path(directories$bmi, basename(file))
#   file.rename(file, new_file)
# }
# print("BMI files have been moved to the new directory.")
# 
# # Move brc files
# brc_files <- list.files(path = "~/", pattern = "^brc_subgroup_\\d+_iteration_\\d+\\.csv$", full.names = TRUE)
# for (file in brc_files) {
#   new_file <- file.path(directories$brc, basename(file))
#   file.rename(file, new_file)
# }
