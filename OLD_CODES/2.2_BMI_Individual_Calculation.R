...
##################################################################  
##################################################################
##### bmi: Unsupervised RA Methods Calcluation ################
##################################################################
##################################################################
...
old_dir <- "~/"
new_dir <- "2.2_bmi_test_subgroup_files"
...
# input_dir <- "2.2_bmi_test_subgroup_files"
# output_dir <- "2.2_bmi_transposed_files_test"
# 
# # Create the new directory if it does not exist
# dir.create(output_dir, showWarnings = FALSE)
# 
# # Define the single file to be tested
# test_file <- file.path(input_dir, "bmi_subgroup_1_iteration_1.csv")
# 
...
# library(readr)
# bmi_subgroup_1_iteration_1 <- read_csv("2.2_bmi_test_subgroup_files/bmi_subgroup_1_iteration_1.csv")
# View(bmi_subgroup_1_iteration_1)
# 
# 
# library(readr)
# transposed_bmi_subgroup_1_iteration_1 <- read_csv("2.2_bmi_transposed_files_test/transposed_bmi_subgroup_1_iteration_1.csv")
# View(transposed_bmi_subgroup_1_iteration_1)
# 
...
# Define the directories
input_dir <- "2.2_bmi_test_subgroup_files"
transposed_dir <- "2.2_bmi_transposed_files"
ranked_dir <- "2.2_bmi_ranked_transposed_files"
...
# input_dir <- "2.2_bmi_test_subgroup_files"
# output_dir <- "2.2_bmi_transposed_files"
# 
# # Create the new directory if it does not exist
# dir.create(output_dir, showWarnings = FALSE)
# 
