########################################################
####     Step 1: Transpose the M * N+5 --> N *M     ####
##########################################################

# ALREADY DID! the files are in 3 folders:
  # 2.2_height_transposed_files
  # 2.2_bmi_transposed_files
  # 2.2_brc_transposed_files
...
adjusted_output_folder <- "adjusted_score_results"
...
folders <- list(
  "height" = "2.2_height_transposed_files",
  "bmi" = "2.2_bmi_transposed_files",
  "brc" = "2.2_brc_transposed_files"
)
...
adjusted_score_dir <- "adjusted_score_results"
ranked_score_dir <- "adjusted_ranked_score_results"
